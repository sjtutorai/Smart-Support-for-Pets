    ...
    <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center p-6 font-inter">
      <div className="max-w-md w-full bg-white rounded-[3rem] shadow-2xl border border-slate-100 p-8 md:p-12 animate-in fade-in zoom-in-95 duration-700 overflow-y-auto max-h-[90vh] custom-scrollbar">
        ...
        <div className="flex flex-col gap-3 mb-8">
          <button onClick={handleGoogleLogin} className="flex items-center justify-center gap-3 bg-white border border-slate-200 py-3.5 rounded-2xl font-black text-[10px] uppercase tracking-widest text-slate-700 hover:bg-slate-50 transition-all shadow-sm active:scale-95" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px' }}>
            <svg viewBox="0 0 24 24" width="20" height="20" style={{ width: '20px', height: '20px', minWidth: '20px' }} className="w-5 h-5" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button onClick={handleAppleLogin} className="flex items-center justify-center gap-3 bg-slate-900 py-3.5 rounded-2xl font-black text-[10px] uppercase tracking-widest text-white hover:bg-black transition-all shadow-xl active:scale-95" style={{ backgroundColor: '#0f172a', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px' }}>
               <svg width="16" height="16" style={{ width: '16px', height: '16px', minWidth: '16px' }} className="w-4 h-4" viewBox="0 0 384 512" fill="currentColor"><path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 21.8-88.5 21.8-11.4 0-51.1-22.1-82.6-22.1-41.9 0-80.6 24.1-102.2 61.9-43.2 75.3-11.1 185.9 31.5 247.4 20.8 29.9 45.3 63.6 77.3 62.6 31.1-1 42.8-20.1 80.5-20.1 37.7 0 48.6 20.1 80.5 19.3 32.7-.8 53.7-30.5 73.8-60 23.2-33.9 32.7-66.8 33-68.5-.8-.4-64.1-24.6-64.4-97.5zm-58.5-157.4c16-19.7 26.8-47 23.8-74.3-23.3 1-51.3 15.6-68 35.3-14.9 17.5-28 45.3-24.5 71.5 26.1 2 52.7-12.8 68.7-32.5z"/></svg>
               Apple
            </button>
            <button onClick={handleGithubLogin} className="flex items-center justify-center gap-3 bg-white border border-slate-200 py-3.5 rounded-2xl font-black text-[10px] uppercase tracking-widest text-slate-800 hover:bg-slate-50 transition-all shadow-sm active:scale-95" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px' }}>
               <Github size={16} />
               GitHub
            </button>
          </div>
